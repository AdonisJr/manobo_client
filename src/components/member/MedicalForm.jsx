...
export default function MedicalForm({ user, accessToken, getMedical, setIsShowForm }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`/medical`, filesData, {
            headers: {
        ...
        <>
            <div className='absolute top-0 left-0 flex w-full h-full p-10 justify-center items-center z-40'>
                ...
                <div className='relative flex flex-col gap-3 bg-white p-5 w-3/6 h-3/6 shadow-lg'>
                    <p className='text-lg font-bold'>Medical Assistance Form</p>
                    ...
                    <div className='flex items-center justify-between gap-2'>
                        <p className='ps-2'>Medical Abstract</p>
                        <input
                            type="file"
                            className="px-3 py-1 rounded-md w-5/6"
