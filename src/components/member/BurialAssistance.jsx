...
export default function SchoolarshipAssistance({ user, accessToken }) {
  ...
  const handleConfirm = async () => {
    ...
    await axios
      .post(`/assistance`, { user_id: user.id, type: 'burial' }, {
        headers: {
    ...
    <div className='flex flex-col gap-2'>
      <div className='flex flex-col gap-2 bg-white p-5 rounded-lg shadow-md'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <p className='font-semibold'>DEATH CERTIFICATE
            <span className='font-normal'>(Please be advised that the submission of the death certificate for processing is mandatory, and it should be presented in person at the office.)</span>
          </p>
          <p className='font-semibold'>BARANGAY INDIGENCY
