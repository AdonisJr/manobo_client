...
export default function Mem({ accessToken, user }) {
    ...
    return (
        <div className='flex flex-col gap-5 w-full bg-white p-2'>
            ...
            <div className='flex gap-3 px-5 justify-between'>
                <div className='flex gap-2 items-center ps-5 w-2/6 text-sm'>
                    <label>Search:</label>
                    <input type='search'
                        placeholder='Search: Special Skills'
                        className='border-2 border-slate-200 w-full p-1'
