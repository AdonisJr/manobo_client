...
export default function RecommendationForm({ user, accessToken, getRecommendations, setIsShowForm }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`/recommendation`, filesData, {
            headers: {
        ...
        <>
            <div className='absolute top-0 left-0 flex w-full h-full p-10 justify-center items-center z-40'>
                ...
                <div className='relative flex flex-col gap-3 bg-white p-5 w-3/6 h-3/6 shadow-lg'>
                    <p className='text-lg font-bold'>Recommendation Form</p>
