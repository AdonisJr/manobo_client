    ...
    return (
        <div className='flex flex-col gap-5 w-full bg-white p-2'>
            <div className='ps-5 pt-5'>
                <p className='font-bold text-lg text-slate-500'>Staff Accounts Management</p>
            </div>
            <div>
                {
                    !isModalOpen ? <></> :
            ...
            <div className='w-full p-2 bg-'>
                <StaTable printRef={printRef} staff={staff} setModal={setModal} setSelected={setSelected} selected={selected} accessToken={accessToken} />
            </div>
        </div>
    )
}
