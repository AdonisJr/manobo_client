...
<div className="flex justify-center text-slate-300 hover:text-white duration-200">
      ...
      <div className="flex flex-col gap-5">
        <button
          className={`flex gap-1 items-center hover:bg-emerald-500 text-white hover:text-white duration-200 p-2 rounded-md ${activePage === "Dashboard" ? "text-white bg-emerald-500" : "text-white"
            } duration-200`}
        ...
        <button
          className={`flex gap-1 items-center hover:bg-emerald-500 text-white hover:text-white duration-200 p-2 rounded-md ${activePage === "Member" ? "text-white bg-emerald-500" : "text-white"
            } duration-200`}
        ...
        <button
          className={`flex gap-1 items-center hover:bg-emerald-500 text-white hover:text-white duration-200 p-2 rounded-md ${activePage === "Census" ? "text-white bg-emerald-500" : "text-white"
            } duration-200`}
          onClick={() => handleActivePage("Census")}
        >
      ...
      <footer>
      <a href="/announcements" className="flex gap-1 py-8 justify-center items-center hover:underline text-red-500 cursor-pointer text-center font-serif"
      >
        ...
        <button className="flex gap-1 items-center justify-center w-full p-2 bg-white border-2 border-emerald-500 hover:bg-emerald-500 hover:text-white duration-200 rounded-md"
          onClick={() => {
            cookies.remove("user");
            setUser({});
            setAccessToken('');
