...
export default function EnuForm({ setSelected, setModal, selected, accessToken }) {
    const [credentials, setCredentials] = useState(selected.id ? selected : { role: "enumerator" });
                ...
                <form className="relative w-auto my-6 mx-auto max-w-3xl">
                    ...
                    <div className="flex flex-col border-0 rounded-lg shadow-lg relative w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                            <h3 className="text-2xl font-semibold">{selected.id ? "UPDATE" : "ADD"} ENUMERATOR</h3>
                            <button
